...
from omnexa_theme_manager.tm_gap_register import get_gap_status
from omnexa_theme_manager.tm_global_benchmark import get_global_tm_score

@frappe.whitelist()
def export_tm_global_audit() -> dict:
	root = os.path.join(get_bench_path(), "Docs", "2026-06-06_OMNEXA_THEME_MANAGER_GLOBAL_AUDIT")
	os.makedirs(root, exist_ok=True)
	score, gaps = get_global_tm_score(), get_gap_status()
